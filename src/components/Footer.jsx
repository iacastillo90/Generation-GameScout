...
function Footer () {
    return (
        <footer className="bg-dark text-light py-4 mt-auto border-top border-secondary text-center">
            <div className="container">
                
                <div className="footer-info mb-3">
                    <p className="mb-1"><i className="bi bi-envelope-fill me-2"></i> soporte@gamescout.com</p>
